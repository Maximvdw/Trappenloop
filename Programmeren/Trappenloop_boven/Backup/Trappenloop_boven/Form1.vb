    ...
    Public Sub Stopwatch()
        ...
        Else
            ...
            While Stopwatch_On = True
                ...
                lbl_timer.Text = String.Format("{0:00}:{1:00}:{2:0}", Span.Minutes, Span.Seconds, (Span.Milliseconds / 10).ToString.Substring(0, 1))
                '' Ververs de Timer
                Me.Refresh()
                lbl_timer.Refresh()
    ...
    Private Sub listener_StringReceived(ByVal Sender As tcpConnection, ByVal msgTag As Byte, _
        ...
        Select Case True
            ...
            Case message.ToUpper.StartsWith("%START%") '%START%Maxim Van de Wynckel
                ...
                Label_message_STR = "'" & Naam & "'" & vbNewLine & "Druk op de Rode knop om uw tijd vast te leggen."
